...
# run it, leave it a while and then take a look at: https://thingspeak.com/apps/matlab_visualizations/33445   :)
...
def main():
  ...
  if os.path.isfile('/boot/templogger.cfg')==True:
    print "Found /boot/templogger.cfg"
    ...
    if data[0]=='Temp Logger':
      ...
      print "looks like the wrong config file"
  else:
    print "could not find /boot/templogger.cfg"
...
#      sys.stdout.flush()
      ...
      sendData(THINGSPEAKURL,THINGSPEAKKEY,temperature,pressure)
      sys.stdout.flush()
